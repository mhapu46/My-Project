...
import com.example.earthquake.databinding.EarthquakeRowBinding
import com.example.earthquake.models.EarthquakeModel
import com.example.earthquake.network.getFormattedDate

class EarthquakeAdapter : ListAdapter<EarthquakeModel.Metadata, EarthquakeAdapter.EarthquakeViewholder>(ForecastDiffUtil()){
